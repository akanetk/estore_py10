...
def search(request):
    ...
    return render(request, 'store/product-list.html',{
        'products': products_pager, # khai báo đúng biến ánh xạ qua html không cần làm lại nhiều lần(products đã khai báo trong function productlist)
...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    #permission_classes = [permissions.IsAdminUser] # user admin có thể chỉnh sửa api
    permission_classes = [permissions.IsAuthenticatedOrReadOnly] # xét quyền user truy cập chỉ được đọc không thể chỉnh sửa
