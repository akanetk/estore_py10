...
class Category(models.Model):
    ...
    def __str__(self): #định nghĩa ban đầu
        return self.name
...
class Product(models.Model):
    ...
    class Meta:
        ordering = ('-public_day',) #can thiệp hiển thị mặc định của django model,vd đặt lại tên trên trang admin,sắp xếp số thứ tự ngày post
